...
print("Question 1:")
print(" "*5,"b- את גודל האובייקט בזיכרון בבייטים")
# שאלה 2
...
print("Question 2:")
print(" "*5,"c- האובייקט משוחרר מהזיכרון באופן מיידי")
# שאלה 3
...
print("Question 4:")
print(" "*5,"c - אובייקטים המפנים אחד לשני במעגל שאינם משוחררים באמצעות Reference Counting בלבד")
...
print("Question 5:")
print(" "*5,"b - הפניה שאינה מגדילה את מונה ההפניות לאובייקט ")
# שאלה 6
...
print("Question 6:")
print(" "*5,"a - מצב בו זיכרון שאינו בשימוש אינו משוחרר לאורך זמן ")
# שאלה 7
...
print("Question 7:")
print(" "*5,"b - מנעול שמגביל את ריצת הקוד כך שרק thread אחד יכול לבצע קוד Python בזמן נתון ")
# שאלה 8
...
print("Question 8:")
print(" "*5,"b - שימוש ב-multiprocessing במקום multithreading ")
# שאלה 9
...
print("Question 9:")
print(" "*5,"c - מצב בו התוצאה תלויה בסדר או בעיתוי הביצוע של פעולות מקביליות ")
# שאלה 10
...
print("Question 10:")
print(" "*5,"b - מניעת גישה בו-זמנית למשאב משותף ")
# שאלה 11
...
print("Question 11:")
print(" "*5,"b - לאתחל את המופע (instance) של המחלקה ולקבוע את מצבו ההתחלתי ")
# שאלה 12
...
print("Question 12:")
print(" "*5,"a - כן, פייתון תומך באופן מלא בירושה מרובה")
# שאלה 13
...
print("Question 13:")
print(" "*5,"b - ב: Class Method מקבלת את המחלקה כפרמטר ראשון (cls), בעוד Instance Method מקבלת את האובייקט כפרמטר ראשון (self)")
# שאלה 14
...
print("Question 14:")
print(" "*5,"a - לביצוע פעולות שאינן תלויות במצב האובייקט או המחלקה")
# שאלה 15
...
print("Question 15:")
print(" "*5,"c - לאפשר גישה למשתני מחלקה כאילו הם תכונות רגילות, תוך הוספת לוגיקה בעת קריאה וכתיבה")
# שאלה 16
...
print("Question 16:")
print(" "*5,"b - לגשת למתודות וערכים של מחלקת הבסיס (מחלקת האב) בירושה")
# שאלה 17
...
print("Question 17:")
print(" "*5,"c - כן, אבל רק אם המחלקה היורשת אינה מוגדרת כאבסטרקטית בעצמה")
# שאלה 18
...
print("Question 18:")
print(" "*5,"b - לנהל ולשמור מידע על התנהגות התוכנית בזמן ריצה, לצורכי ניטור, איתור באגים ותחזוקה")
# שאלה 19
...
print("Question 19:")
print(" "*5,"b - עקרון לפיו נתונים ופעולות על הנתונים נארזים יחד ביחידה אחת, תוך הסתרת המימוש הפנימי ומתן גישה מבוקרת")
# שאלה 20
...
print("Question 20:")
print(" "*5,"b - עקרון המאפשר לאותה פעולה (מתודה) להתנהג באופן שונה כאשר היא מיושמת במחלקות שונות")
# שאלה 21
...
print("Question 21:")
print(" "*5,"b - מנגנון שמאפשר למחלקה בת להגדיר מחדש את המימוש של מתודה שירשה ממחלקת האב")
# שאלה 22
...
print("Question 22:")
print(" "*5,"b - מחלקה שמשמשת כתבנית למחלקות אחרות, מכילה מתודות אבסטרקטיות ולא ניתן ליצור ממנה מופע ישירות")
# שאלה 23
...
print("Question 24:")
print(" "*5,"b - לשמש כמזהה ייחודי לאובייקטים ולאפשר שימוש יעיל במבני נתונים כמו סטים ומילונים, משתמשים בפונקציה hash")
# שאלה 25
...
print("Question 25:")
print(" "*5,"b - המערכת תזרוק TypeError בכל פעם שמנסים להשוות בין האובייקטים ")
